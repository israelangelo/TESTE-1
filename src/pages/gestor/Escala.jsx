    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: 12, color: T.muted, marginTop: 1 }}>Atribuição de lojas por dia</div>
        </div>
      </div>
        ...
        <div style={{ display: 'flex', gap: 10, marginTop: 12 }}>
          ...
          <button
            ...
            style={{
              ...
              fontSize: 15, borderRadius: T.r16,
      ...
      <div style={{ padding: '24px 16px 0' }}>
        <div style={{
          ...
          letterSpacing: 0.5, marginBottom: 14, color: T.muted,
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontSize: 11, color: T.muted, marginBottom: 3, textTransform: 'uppercase', letterSpacing: 1 }}>Data</div>
                <div style={{ fontSize: 15, fontWeight: 700 }}>{formatData(sheet.data)}</div>
              </div>
            </div>
            ...
            <button
              onClick={() => setSheet(null)}
              style={{ ...S.btnGhost, width: 'calc(100% - 40px)', margin: '10px 20px 0', padding: '12px 0', fontSize: 14 }}
            >
              Fechar
            </button>
          </div>
